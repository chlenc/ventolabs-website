            ...
            <ScrollReveal key={card.source} delay={i * 120}>
              <a href={card.sourceUrl} target="_blank" rel="noopener noreferrer" className="roi-card">
                <div className="roi-card__header">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    className="roi-card__logo-img"
                    src={asset(`/images/logo-${card.logo}.png`)}
                    alt={card.source}
                    width={22}
                    height={22}
                  />
      ...
      <div className="container">
        <ScrollReveal>
          <div className="final-cta">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={asset("/images/ai-assistant-box.png")} alt="" className="final-cta__image" />
            <div className="final-cta__content">
              <h2>Start with a free AI agent — book a call today</h2>
              <p style={{ color: "rgba(255,255,255,0.6)" }}>
                20-minute discovery call. No pitch, no pressure. We&apos;ll build and deploy your AI agent for free.
              </p>
