              ...
              <a href={card.sourceUrl} target="_blank" rel="noopener noreferrer" className="roi-card">
                <div className="roi-card__header">
                  <span className="roi-card__logo-icon">
                    {card.logo === "stanford" && (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L1 7l11 5 11-5-11-5zM1 17l11 5 11-5M1 12l11 5 11-5"/></svg>
                    )}
                    {card.logo === "science" && (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M9 3v6l-4 8h14l-4-8V3M8 3h8"/><circle cx="12" cy="19" r="1" fill="currentColor"/></svg>
                    )}
                    {card.logo === "github" && (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d={siGithub.path}/></svg>
                    )}
                  </span>
