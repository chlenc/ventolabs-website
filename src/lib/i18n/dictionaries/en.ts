...
export const en: Dictionary = {
  ...
  case_pages: {
    ...
    "bankruptcy-agent": {
      ...
      seo: {
        title: "Bankruptcy AI — AI platform for Russian arbitration trustees",
        description: "AI platform for Russian arbitration trustees: procedural documents with Supreme Court practice, 127-FZ / APC deadline control, EFRSB integration, debtor due-diligence under arts. 61.2 / 61.3. Free demo on your real case. Page in Russian.",
      },
      ctaPrimary: { label: "Get a free demo", href: "https://t.me/defi_defiler", meta: "30 min · on your case · NDA", kind: "telegram" },
      ctaSecondary: { label: "Call to discuss", href: "tel:+79032333525", meta: "+7 903 233 35 25", kind: "phone" },
      trustStrip: [
      ...
      finalCta: {
        badge: "Free demo · 30 minutes",
        heading: "Run Bankruptcy AI on one of your procedures",
        subtitle: "We show how the platform assembles a meeting report, drafts a motion and surfaces challengeable transactions on the materials of one of your real cases (NDA upfront). No decks, no abstractions.",
        primary: { label: "Book a demo", href: "https://t.me/defi_defiler", meta: "Telegram · reply within an hour", kind: "telegram" },
        secondary: { label: "Call to discuss", href: "tel:+79032333525", meta: "+7 903 233 35 25", kind: "phone" },
      },
    },
  },
