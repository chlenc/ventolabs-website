...
// OpenAI mark — not included in simple-icons; inlined SVG path.
const openaiPath =
...
const logos = [
  ...
  { name: "Google Sheets", path: siGooglesheets.path },
  { name: "Make", path: siMake.path },
  { name: "Cursor", path: siCursor.path },
