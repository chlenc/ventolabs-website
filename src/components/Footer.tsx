...
import { getContactForPath } from "@/lib/contact";
...
export function Footer() {
  ...
  const contact = getContactForPath(pathname);
        ...
        <div className="footer__top">
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              ...
              <a href={contact.whatsapp} title="WhatsApp" aria-label="WhatsApp" target="_blank" rel="noopener">
          ...
          <div className="footer__col">
            <h5>{dict.footer.servicesHeading}</h5>
            {dict.footer.servicesLinks.map((link) => (
          ...
          <div className="footer__col">
            <h5>{dict.footer.companyHeading}</h5>
          ...
          <div className="footer__col">
            <h5>{dict.footer.contactHeading}</h5>
            <a href={`mailto:${site.email}`}>{site.email}</a>
            <a href={contact.whatsapp} target="_blank" rel="noopener">{contact.phoneDisplay}</a>
            <a href={site.telegram} target="_blank" rel="noopener">
              {dict.footer.telegramLabel} {site.telegramHandle}
            </a>
            <a href={site.linkedin} target="_blank" rel="noopener">{dict.footer.linkedinLabel}</a>
          </div>
        </div>
