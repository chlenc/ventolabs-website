...
args = ["--base", "http://localhost:8080/hs/mcp-1c"]`,
...

    {
      ...
      blocks: [
        ...
        {
          kind: "p",
          text: "Стек из этого раздела отвечает на вопрос «чем работать». Отдельный вопрос — что этому стеку разрешено делать с рабочей базой: под каким пользователем агент заходит, что он может писать и кто это подтверждает. Он разобран в [гайде о внедрении AI-агента в 1С](/blog/ai-agent-dlya-1c-vnedrenie/), а как та же архитектура выглядит на реальном контуре — в [кейсе 1C Agent](/cases/erp-agent/).",
        },
      ],
    },
