    ...
    <div className="fab">
      {open && (
        <div className="fab__menu" onClick={() => setOpen(false)}>
          <a href={site.telegram} target="_blank" rel="noopener" className="fab__option" onClick={(e) => e.stopPropagation()}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 5L2 12.5l7 1.5M21 5l-7 15-4.5-8.5M21 5L9 14"/>
            </svg>
            <span>Telegram</span>
          </a>
          <a href={site.whatsapp} target="_blank" rel="noopener" className="fab__option" onClick={(e) => e.stopPropagation()}>
          ...
          <a href={`mailto:${site.email}`} className="fab__option" onClick={(e) => e.stopPropagation()}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 7l-10 7L2 7"/>
            </svg>
            <span>Email</span>
          </a>
          <button className="fab__option" onClick={(e) => { e.stopPropagation(); setOpen(false); openCalendly(); }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
